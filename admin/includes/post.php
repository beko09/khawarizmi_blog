        ...
        <tbody>
            ...
            <tr>
                ...
                <?php
                                ...
                                ?>
                <td><a class="btn btn-warning btn-block" href="posts.php?unapprove=<?php echo $post_id; ?>"> عدم
                        الموافقة
                    </a></td>'
                <?php
                            }
                ...
                <td><?php echo "<a href='posts.php?to=edit_post&edit_post=$post_id' class='btn btn-info btn-block'> تعديل
                        </a>"; ?></td>
