            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo "<a class='btn btn-success btn-block' href='posts.php?approve=$post_id'> موافقة
                        </a>"; ?></td>
                         <td><?php echo "<a class='btn btn-warning btn-block' href='posts.php?unapprove=$post_id'> عدم الموافقة
                        </a>"; ?></td>
